...
from bruvtab.files import slurp_lines
from bruvtab.mediator.const import DEFAULT_HTTP_IFACE
from bruvtab.mediator.const import DEFAULT_MAX_HTTP_PORT
from bruvtab.mediator.const import DEFAULT_MIN_HTTP_PORT
from bruvtab.mediator.log import mediator_logger

CONFIG = environ.get('XDG_CONFIG_HOME', expanduser('~/.config'))
DEFAULT_FILENAME = '{0}/bruvtab/bruvtab.env'.format(CONFIG)
